        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="card bg-dark text-white"> <!-- Kartu hitam untuk Ringkasan Hari Ini -->
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <small class="text-light">Export data transaksi hari ini</small>
                                </div>
                                <div>
                                    <button class="btn btn-success btn-sm me-2" id="printTodayBtn">
                ...
                <div id="transactionsTable">
                    ...
                    <div class="card mb-4">
                        <div class="card-header bg-light">
                            <h6 class="mb-0">
                                <i class="bi bi-arrow-down-circle me-2"></i>Tracker
                            </h6>
                        </div>
                        <div class="card-body">
                            <!-- Quick Stats -->
...
<style>
    ...
    /* Custom styling for Ringkasan Hari Ini card */
    .card.bg-dark {
        border: none;
